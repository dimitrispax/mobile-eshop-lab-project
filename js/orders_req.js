...
oReq.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
        ...
        data.forEach(element => {
            ...
            card.classList.add('card', 'p-card', 'bg-white', 'p-2', 'px-3', 'mt-5', 'border-secondary');
            ...
            date.textContent = "Purchased at: ";
            card.appendChild(date);

            let spanDate = document.createElement('span');
            spanDate.textContent = element.date;
...
oReq.open("get", "../get_orders.php", true);
